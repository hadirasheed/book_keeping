  ...
  return (
    ...
    >
      <div className="flex flex-col items-center text-center">
        ...
        <h1 className="mt-4 text-xl font-semibold">AI Bookkeeping</h1>
      ...
      >
        {digits.map((d, i) => (
          <input
            ...
            autoFocus={i === 0}
            className="size-14 rounded-lg border border-input bg-background text-center text-2xl font-semibold shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
          />
        ))}
      </div>
